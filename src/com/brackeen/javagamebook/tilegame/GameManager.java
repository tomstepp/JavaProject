    ...
    */
        ...
        boolean canKill)
    {
        ...
        if (collisionSprite instanceof PowerUp) {
            ...
            if (canKill) {
                // kill the bad guy and make player bounce
                soundManager.play(boopSound);
    ...
    public void checkSpriteCollision(Creature creature){
    	...
    	Sprite bullet = getBulletCollision(creature);
    ...
    public Sprite getBulletCollision(Creature creature) {

        // run through the list of Sprites
        Iterator i = map.getSprites();
        while (i.hasNext()) {
            Sprite otherSprite = (Sprite)i.next();
            if (isCollision(creature, otherSprite)) {
                // collision found, return the Sprite
